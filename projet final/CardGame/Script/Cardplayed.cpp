...
Cardplayed::Cardplayed(Deck* cardd) : deckcard(cardd) {
    ...
    for(int i = 0 ; i < SizeOfDeck ; i++){
        ...
        labels[i]->setPixmap(QPixmap::fromImage(deckcard->GetCurrentImgCard(i)->scaledToHeight(100)));
    if( i < 10 )
