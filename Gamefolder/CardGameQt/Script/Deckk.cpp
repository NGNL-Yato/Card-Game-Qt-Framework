...
Deckk::Deckk(){
    ...
    DeckBackward = new QImage(GameFolderPath + "/Gamefolder/CardGameQt/Assets/Cards/BackCard.png");
...
void Deckk::shuffle(){
    ...
    QString GameFolderPath = QStandardPaths::writableLocation(QStandardPaths::DesktopLocation);
    CardShuffle->setSource(QUrl::fromLocalFile(GameFolderPath + "/Gamefolder/CardGameQt/Assets/Audio/Shuffle.mp3"));
